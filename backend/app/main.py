...
# ── FastAPI app ──────────────────────────────────────────────────────
app = FastAPI(title="Emma Adventure Backend", version="3.0.0")
...
@app.get("/api/health")
def health():
    return {"ok": True, "service": "emma-fastapi", "version": "3.0.0", "channels": CHANNELS}
